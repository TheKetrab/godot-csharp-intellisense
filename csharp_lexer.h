...
public:
	...
	const int CONTEXT_KEYWORDS_BEGIN = TK_KW_ADD;
	const int CONTEXT_KEYWORDS_END = TK_KW_YIELD;
	const int OPS_BEGIN = TK_OP_ADD;
	const int OPS_END = TK_OP_ASSIGN_RIGHT_SHIFT;
